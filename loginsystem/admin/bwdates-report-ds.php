            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-4">Просмотр логов по дате</h1>
                        <div class="card mb-4">
                     <form method="post" name="bwdatesreport" action="bwdates-report-result.php" >
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="submit">Подтвердить</button></td>
