...
if($msg)
{
    echo "<script>alert('Профиль обновлен успешно');</script>";
...
{?>
                        <h1 class="mt-4">Профиль <?php echo $result['fname'];?></h1>
                        <div class="card mb-4">
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="update">Обновить</button></td>
